...
This architecture offers a structured, fast and computationally lightweight approach to motion applications.
...
The architecture is fully documented in intent and functionality and in combination with the TR3056 in Nuremberg the path to market and the time to market is supported from day 1.
